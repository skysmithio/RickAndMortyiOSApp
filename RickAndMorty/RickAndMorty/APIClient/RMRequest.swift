...
extension RMRequest {
    ...
    static let listEpisodesRequest = RMRequest(endpoint: RMEndpoint.episode)
    static let listLocationsRequest = RMRequest(endpoint: RMEndpoint.location)
}
